...
**1B) MANUAL CONSOLE METHOD -- INGOT**
 ...
 - ``` (function () {var a = document.createElement('script');a.src =
   'https://cdn.jsdelivr.net/gh/FogNetwork/Ingot@latest/ingot.min.js';document.body.appendChild(a);}())
   ```
...
----------------
### 3) POINT BLANK SWAP LAUNCHER METHOD
